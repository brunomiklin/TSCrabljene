...
$objave_strojarstvo = odaberiSve('objave', ['razred' => 1 , 'smjer' => 'ST']);
$objave_racunlastvo = odaberiSve('objave', ['razred' => 1 , 'smjer' => 'RT']);
$objave_mehatronika = odaberiSve('objave', ['razred' => 1 , 'smjer' => 'MT']);
$objave_eletrotehnika = odaberiSve('objave', ['razred' => 1 , 'smjer' => 'ET']);
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="okvir-slidera">
        ...
        <div class="slider-objave" id="strojarstvo">
            ...
            <h1 class="naslov-slider">STROJARSKI RAČUNALNI TEHNIČAR - 1.RAZRED</h1>
        ...
        <div class="slider-objave" id="racunalstvo">
            ...
            <h1 class="naslov-slider">TEHNIČAR ZA RAČUNALSTVO - 1.RAZRED</h1>
        ...
        <div class="slider-objave" id="mehatronika">
            ...
            <h1 class="naslov-slider">TEHNIČAR ZA MEHATORNIKU - 1.RAZRED</h1>
        ...
        <div class="slider-objave" id="elektrotehnika">
            ...
            <h1 class="naslov-slider">ELEKTROTENHIČAR - 1.RAZRED</h1>
